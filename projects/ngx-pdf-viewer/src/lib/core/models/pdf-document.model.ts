/** A single entry in a PDF document outline (recursive tree) */
...
export interface PDFDocumentProxy {
  ...
  /**
   * Releases document resources. There is no `destroy()` on PDFDocumentProxy —
   * tearing a document down means destroying its `PDFDocumentLoadingTask`.
   */
...
export type PDFSource = string | URL | Uint8Array | ArrayBuffer | PDFDocumentParameters | PDFDataRangeTransport;
